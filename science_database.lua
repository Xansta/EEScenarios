...
---------------------------------------------------------------------
	...
	if cruiser_db == nil then
		...
		cruiser_db:setImage("radar_cruiser.png")
	end
--------------------------
--	Stock player ships  --
--------------------------
...
--	Ender
	...
	ender_db:setImage("radar_battleship.png")
...
--	Chavez
	...
	chavez_db:setImage("radar_piranha.png")
--	Eldridge
...
--	Twister
	...
	twister_db:setImage("radar_ktlitan_destroyer.png")
--	Windmill
...
--	Peacock
	...
	peacock_db:setImage("radar_cruiser.png")
--	Phoenix
