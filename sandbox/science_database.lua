function initialSandboxDatabaseUpdate()
	...
	local alt_universe_db = queryScienceDatabase("Factions","Alternate Universe")
	if alt_universe_db == nil then
		faction_db:addEntry("Alternate Universe")
		alt_universe_db = queryScienceDatabase("Factions","Alternate Universe")
	end
	alt_universe_db:setLongDescription("These factions are found when crossing over to an alternate universe. Some of them seem to roughly correlate to factions in the 'normal' universe, but there are differences. Use caution when interacting with these factions.")
	local cindys_remnants_db = queryScienceDatabase("Factions","Alternate Universe","Cindy's Remnants")
	if cindys_remnants_db == nil then
		alt_universe_db:addEntry("Cindy's Remnants")
		cindys_remnants_db = queryScienceDatabase("Factions","Alternate Universe","Cindy's Remnants")
	end
	cindys_remnants_db:setLongDescription("Cindy's Remnants came from a failed subspace rift experiment on station Cindy's Folly. The experiment transported all the station personnel across to a mirror universe where they had to survive with whatever they had. They ended up conquering several areas in the mirror universe largely due to their superior technology from their original universe and survival skills.")
	cindys_remnants_db:setKeyValue("Independent","Neutral")
	cindys_remnants_db:setKeyValue("Human Navy","Friendly")
	cindys_remnants_db:setKeyValue("Kraylor","Enemy")
	cindys_remnants_db:setKeyValue("Arlenians","Neutral")
	cindys_remnants_db:setKeyValue("Exuari","Enemy")
	cindys_remnants_db:setKeyValue("Ghosts","Enemy")
	cindys_remnants_db:setKeyValue("Ktlitans","Enemy")
	cindys_remnants_db:setKeyValue("TSN","Friendly")
	cindys_remnants_db:setKeyValue("USN","Friendly")
	cindys_remnants_db:setKeyValue("CUF","Friendly")
	cindys_remnants_db:setKeyValue("Holy Terra","Enemy")
	cindys_remnants_db:setKeyValue("Spacer","Neutral")
	cindys_remnants_db:setKeyValue("Snow Slayers","Friendly")
	local holy_terra_db = queryScienceDatabase("Factions","Alternate Universe","Holy Terra")
	if holy_terra_db == nil then
		alt_universe_db:addEntry("Holy Terra")
		holy_terra_db = queryScienceDatabase("Factions","Alternate Universe","Holy Terra")
	end
	holy_terra_db:setLongDescription("Holy Terra are imperialistic, expansionistic, mostly human. They don't get along with hardly anyone. They'd much rather blow them up than talk to them.")
	holy_terra_db:setKeyValue("Independent","Enemy")
	holy_terra_db:setKeyValue("Human Navy","Enemy")
	holy_terra_db:setKeyValue("Kraylor","Enemy")
	holy_terra_db:setKeyValue("Arlenians","Enemy")
	holy_terra_db:setKeyValue("Exuari","Enemy")
	holy_terra_db:setKeyValue("Ghosts","Enemy")
	holy_terra_db:setKeyValue("Ktlitans","Enemy")
	holy_terra_db:setKeyValue("TSN","Enemy")
	holy_terra_db:setKeyValue("USN","Enemy")
	holy_terra_db:setKeyValue("CUF","Enemy")
	holy_terra_db:setKeyValue("Cindy's Remnants","Enemy")
	holy_terra_db:setKeyValue("Spacer","Friendly")
	holy_terra_db:setKeyValue("Snow Slayers","Enemy")
	local spacer_db = queryScienceDatabase("Factions","Alternate Universe","Spacer")
	if spacer_db == nil then
		alt_universe_db:addEntry("Spacer")
		spacer_db = queryScienceDatabase("Factions","Alternate Universe","Spacer")
	end
	spacer_db:setLongDescription("The Spacers largely stay out of politics and conflicts between factions. They only want to explore with the intent to gain knowledge, not exploitation of resources or conquest. The Spacers provide invaluable navigation and other information about the alternate universe.")
	spacer_db:setKeyValue("Independent","Neutral")
	spacer_db:setKeyValue("Human Navy","Neutral")
	spacer_db:setKeyValue("Kraylor","Neutral")
	spacer_db:setKeyValue("Arlenians","Neutral")
	spacer_db:setKeyValue("Exuari","Enemy")
	spacer_db:setKeyValue("Ghosts","Neutral")
	spacer_db:setKeyValue("Ktlitans","Enemy")
	spacer_db:setKeyValue("TSN","Neutral")
	spacer_db:setKeyValue("USN","Neutral")
	spacer_db:setKeyValue("CUF","Neutral")
	spacer_db:setKeyValue("Cindy's Remnants","Neutral")
	spacer_db:setKeyValue("Holy Terra","Friendly")
	spacer_db:setKeyValue("Snow Slayers","Enemy")
	local snow_slayer_db = queryScienceDatabase("Factions","Alternate Universe","Snow Slayers")
	if snow_slayer_db == nil then
		alt_universe_db:addEntry("Snow Slayers")
		snow_slayer_db = queryScienceDatabase("Factions","Alternate Universe","Snow Slayers")
	end
	snow_slayer_db:setLongDescription("This faction is rarely seen. They only seem to appear approximately every 365 days. They have bizarre interests and rituals. Be careful with these people.")
	snow_slayer_db:setKeyValue("Independent","Neutral")
	snow_slayer_db:setKeyValue("Human Navy","Neutral")
	snow_slayer_db:setKeyValue("Kraylor","Neutral")
	snow_slayer_db:setKeyValue("Arlenians","Neutral")
	snow_slayer_db:setKeyValue("Exuari","Neutral")
	snow_slayer_db:setKeyValue("Ghosts","Neutral")
	snow_slayer_db:setKeyValue("Ktlitans","Neutral")
	snow_slayer_db:setKeyValue("TSN","Neutral")
	snow_slayer_db:setKeyValue("USN","Neutral")
	snow_slayer_db:setKeyValue("CUF","Neutral")
	snow_slayer_db:setKeyValue("Cindy's Remnants","Friendly")
	snow_slayer_db:setKeyValue("Holy Terra","Enemy")
	snow_slayer_db:setKeyValue("Spacers","Enemy")
	local equipment_db = queryScienceDatabase("Equipment")
	local independent_db = queryScienceDatabase("Factions","Independent")
	if independent_db == nil then
		faction_db:addEntry("Independent")
		independent_db = queryScienceDatabase("Factions","Independent")
	end
	independent_db:setKeyValue("Cindy's Remnants","Neutral")
	independent_db:setKeyValue("Holy Terra","Enemy")
	independent_db:setKeyValue("Spacers","Neutral")
	independent_db:setKeyValue("Snow Slayers","Neutral")
	local human_navy_db = queryScienceDatabase("Factions","Human Navy")
	if human_navy_db == nil then
		faction_db:addEntry("Human Navy")
		human_navy_db = queryScienceDatabase("Factions","Human Navy")
	end
	human_navy_db:setKeyValue("Cindy's Remnants","Friendly")
	human_navy_db:setKeyValue("Holy Terra","Enemy")
	human_navy_db:setKeyValue("Spacers","Neutral")
	human_navy_db:setKeyValue("Snow Slayers","Neutral")
	local kraylor_db = queryScienceDatabase("Factions","Kraylor")
	if kraylor_db == nil then
		faction_db:addEntry("Kraylor")
		kraylor_db = queryScienceDatabase("Factions","Kraylor")
	end
	kraylor_db:setKeyValue("Cindy's Remnants","Enemy")
	kraylor_db:setKeyValue("Holy Terra","Enemy")
	kraylor_db:setKeyValue("Spacers","Neutral")
	kraylor_db:setKeyValue("Snow Slayers","Neutral")
	local arlenians_db = queryScienceDatabase("Factions","Arlenians")
	if arlenians_db == nil then
		faction_db:addEntry("Arlenians")
		arlenians_db = queryScienceDatabase("Factions","Arlenians")
	end
	arlenians_db:setKeyValue("Cindy's Remnants","Neutral")
	arlenians_db:setKeyValue("Holy Terra","Enemy")
	arlenians_db:setKeyValue("Spacers","Neutral")
	arlenians_db:setKeyValue("Snow Slayers","Neutral")
	local exuari_db = queryScienceDatabase("Factions","Exuari")
	if exuari_db == nil then
		faction_db:addEntry("Exuari")
		exuari_db = queryScienceDatabase("Factions","Exuari")
	end
	exuari_db:setKeyValue("Cindy's Remnants","Enemy")
	exuari_db:setKeyValue("Holy Terra","Enemy")
	exuari_db:setKeyValue("Spacers","Enemy")
	exuari_db:setKeyValue("Snow Slayers","Neutral")
	local ghost_db = queryScienceDatabase("Factions","Ghosts")
	if ghost_db == nil then
		faction_db:addEntry("Ghosts")
		ghost_db = queryScienceDatabase("Factions","Ghosts")
	end
	ghost_db:setKeyValue("Cindy's Remnants","Enemy")
	ghost_db:setKeyValue("Holy Terra","Enemy")
	ghost_db:setKeyValue("Spacers","Neutral")
	ghost_db:setKeyValue("Snow Slayers","Neutral")
	local ktlitan_db = queryScienceDatabase("Factions","Ktlitans")
	if ktlitan_db == nil then
		faction_db:addEntry("Ktlitans")
		ktlitan_db = queryScienceDatabase("Factions","Ktlitans")
	end
	ktlitan_db:setKeyValue("Cindy's Remnants","Enemy")
	ktlitan_db:setKeyValue("Holy Terra","Enemy")
	ktlitan_db:setKeyValue("Spacers","Enemy")
	ktlitan_db:setKeyValue("Snow Slayers","Neutral")
	local tsn_db = queryScienceDatabase("Factions","TSN")
	if tsn_db == nil then
		faction_db:addEntry("TSN")
		tsn_db = queryScienceDatabase("Factions","TSN")
	end
	tsn_db:setKeyValue("Cindy's Remnants","Friendly")
	tsn_db:setKeyValue("Holy Terra","Enemy")
	tsn_db:setKeyValue("Spacers","Neutral")
	tsn_db:setKeyValue("Snow Slayers","Neutral")
	local usn_db = queryScienceDatabase("Factions","USN")
	if usn_db == nil then
		faction_db:addEntry("USN")
		usn_db = queryScienceDatabase("Factions","USN")
	end
	usn_db:setKeyValue("Cindy's Remnants","Friendly")
	usn_db:setKeyValue("Holy Terra","Enemy")
	usn_db:setKeyValue("Spacers","Neutral")
	usn_db:setKeyValue("Snow Slayers","Neutral")
	local cuf_db = queryScienceDatabase("Factions","CUF")
	if cuf_db == nil then
		faction_db:addEntry("CUF")
		cuf_db = queryScienceDatabase("Factions","CUF")
	end
	cuf_db:setKeyValue("Cindy's Remnants","Friendly")
	cuf_db:setKeyValue("Holy Terra","Enemy")
	cuf_db:setKeyValue("Spacers","Neutral")
	cuf_db:setKeyValue("Snow Slayers","Neutral")
...
------------------------------------------------------
	...
	if probe_db == nil then
		...
		probe_db:setImage("radar/probe.png")
		...
		gogo_probe_db:setImage("radar/probe.png")
		...
		mark_3_probe_db:setImage("radar/probe.png")
		...
		screamer_probe_db:setImage("radar/probe.png")
		...
		snag_probe_db:setImage("radar/probe.png")
		...
		swamp_probe_db:setImage("radar/probe.png")
		...
		mire_probe_db:setImage("radar/probe.png")
		...
		spectacle_probe_db:setImage("radar/probe.png")
		...
		binoc_probe_db:setImage("radar/probe.png")
		...
		scope_probe_db:setImage("radar/probe.png")
		...
		patrol_probe_db:setImage("radar/probe.png")
...
--	Ender
	...
	ender_db:setImage("radar/battleship.png")
...
--	Fowl
	...
	fowl_db:setImage("radar/fighter.png")
...
--	Fresnel
	...
	fresnel_db:setImage("radar/ktlitan_fighter.png")
...
--	Gadfly
	...
	gadfly_db:setImage("radar/fighter.png")
...
--	MX-Lindworm
	...
	mx_lindworm_db:setImage("radar/fighter.png")
...
--	Vermin
	...
	vermin_db:setImage("radar/fighter.png")
...
--	Wombat
	...
	wombat_db:setImage("radar/fighter.png")
...
--	XR-Lindworm
	...
	xr_lindworm_db:setKeyValue("Deployed Callsign","Quicksilver, Hummer")
	xr_lindworm_db:setKeyValue("Size","30")
	xr_lindworm_db:setKeyValue("Shield","100/30")
	xr_lindworm_db:setKeyValue("Hull","120")
	xr_lindworm_db:setKeyValue("Repair Crew",3)
	xr_lindworm_db:setKeyValue("Battery Capacity",400)
	xr_lindworm_db:setKeyValue("Warp Speed","19.2 U/min")	--320
	...
	xr_lindworm_db:setKeyValue("Small Tube 0","10 sec / HVLI")
	xr_lindworm_db:setKeyValue("Small Tube 3","10 sec / HVLI, Homing")
	xr_lindworm_db:setKeyValue("Small Tube -3","10 sec / HVLI, Homing")
	xr_lindworm_db:setKeyValue("Tube -90","15 sec / Nuke, EMP")
	xr_lindworm_db:setKeyValue("Tube 90","15 sec / Nuke, EMP")
	xr_lindworm_db:setKeyValue("Tube 180","25 sec / Mine")
	xr_lindworm_db:setKeyValue("Storage Homing","8")
	...
	xr_lindworm_db:setKeyValue("Storage Mine","2")
	xr_lindworm_db:setImage("radar/fighter.png")
...
--	Lurker
	...
	lurker_db:setImage("radar/fighter.png")
...
--	Chavez
	...
	chavez_db:setImage("radar/piranha.png")
...
--	Eldridge
	...
	eldridge_db:setImage("radar/tug.png")
...
--	Flavia 2C
	...
	flavia_2c_db:setImage("radar/tug.png")
...
--	Gull
	...
	gull_db:setImage("radar/tug.png")
...
--	Interlock
	...
	interlock_db:setImage("radar/tug.png")
...
--	Nusret
	...
	nusret_db:setImage("radar/tug.png")
...
--	Pacu
	...
	pacu_db:setImage("radar/piranha.png")
...
--	Phargus
	...
	phargus_db:setImage("radar/cruiser.png")
...
--	Porcupine
	...
	porcupine_db:setImage("radar/tug.png")
...
--	Redhook
	...
	redhook_db:setKeyValue("Shield","100/100")
	redhook_db:setKeyValue("Hull","140")
	...
	redhook_db:setKeyValue("Storage Missiles","H:12 N:4 M:6 E:6 L:20")
	redhook_db:setImage("radar/piranha.png")
...
--	Roc
	...
	roc_db:setImage("radar/cruiser.png")
...
--	Rodent
	...
	rodent_db:setImage("radar/cruiser.png")
...
--	Rook
	...
	rook_db:setImage("radar/tug.png")
...
--	Safari
	...
	safari_db:setImage("radar/tug.png")
...
--	Scatter
	...
	scatter_db:setImage("radar/piranha.png")
...
--	Sloop
	...
	sloop_db:setImage("radar/cruiser.png")
...
--	Squid
	...
	squid_db:setKeyValue("Shield","120/120")
	...
	squid_db:setKeyValue("Storage Missiles","H:8 N:4 M:6 E:4 L:20")
	squid_db:setImage("radar/piranha.png")
...
--	Surkov
	...
	surkov_db:setImage("radar/piranha.png")
...
--	Twister
	...
	twister_db:setKeyValue("Shield","100/120")
	...
	twister_db:setKeyValue("Storage Missiles","H:8 N:4 M:4 E:6 L:16")
	twister_db:setImage("radar/ktlitan_destroyer.png")
...
--	Windmill
	...
	windmill_db:setImage("radar/tug.png")
...
--	Wrocket
	...
	wrocket_db:setImage("radar/piranha.png")
...
--	Amalgam
	...
	amalgam_db:setImage("radar/dread.png")
...
--	Atlantis II
	...
	atlantis_2_db:setImage("radar/dread.png")
...
--	Barrow
	...
	barrow_db:setImage("radar/transport.png")
...
--	Bermuda
	...
	bermuda_db:setImage("radar/dread.png")
...
--	Butler
	...
	butler_db:setImage("radar/laser.png")
...
--	Caretaker
	...
	caretaker_db:setImage("radar/laser.png")
...
--	Crab
	...
	crab_db:setImage("radar/laser.png")
...
--	Destroyer III
	...
	destroyer_3_db:setImage("radar/missile_cruiser.png")
...
--	Destroyer IV
	...
	destroyer_4_db:setKeyValue("Storage Homing",8)
	destroyer_4_db:setKeyValue("Storage Nuke",2)
	destroyer_4_db:setKeyValue("Storage Mine",6)
	destroyer_4_db:setKeyValue("Storage EMP",4)
	destroyer_4_db:setKeyValue("Storage HVLI",12)
	destroyer_4_db:setKeyValue("Turbo Torpedo","Homing / Cyc:55")
	destroyer_4_db:setImage("radar/cruiser.png")
...
--	Fray
	...
	fray_db:setImage("radar/laser.png")
...
--	Kludge
	...
	kludge_db:setImage("radar/cruiser.png")
...
--	Mantis
	...
	mantis_db:setImage("radar/missile_cruiser.png")
...
--	Noble
	...
	noble_db:setKeyValue("Storage Missiles","H:12 N:4 M:8 E:6 L:8")
	noble_db:setImage("radar/cruiser.png")
...
--	Peacock
	...
	peacock_db:setImage("radar/cruiser.png")
...
--	Phoenix
	...
	phoenix_db:setImage("radar/cruiser.png")
...
--	Proto-Atlantis
	...
	proto_atlantis_db:setImage("radar/dread.png")
...
--	Proto-Atlantis 2
	...
	proto_atlantis_db:setLongDescription("Atlantis predecessor: more repair crew, shorter jump drive range, hotter and more inefficient beams, fewer missile types, dedicated tubes for Homing and HVLI left and right, and shorter short range sensors\n\nNarsil differences from Proto-Atlantis: repair crew: 4, move speed: 4.2 U/min, turn speed 14 deg/sec, warp speed: 60 U/min, hull:200, shields:150,150, more efficient beams, extra front tube for HVLI, one tube on each side can shoot homing, EMP and nuke\n\nDeployed as Narsil May2021 for 2 missions.\n\nNarsil went on missions in May2021: searching for freighter Redshirt then using warp samplers to find Kraylor. She was destroyed while deep in Ghost territory.")
	proto_atlantis_db:setKeyValue("Class","Corvette")
	proto_atlantis_db:setKeyValue("Sub-class","Destroyer")
...
--	Raven
	...
	raven_db:setKeyValue("Shield","120/120")
	raven_db:setKeyValue("Hull","160")
	...
	raven_db:setKeyValue("Storage Missiles","H:8 N:4 M:6 E:4")
	raven_db:setImage("radar/cruiser.png")
...
--	Rotor
	...
	rotor_db:setImage("radar/laser.png")
