...
-- Type: Development
function init()
	the_player = PlayerSpaceship():setTemplate("Atlantis"):setPosition(10000,10000)
	CpuShip():setTemplate("Adder MK5"):orderRoaming()
	constructEnvironment()
	home_station:sendCommsMessage(the_player,"Destroy the Kraylor station")
	home_station:sendCommsMessage(other_player ,"Destroy the Kraylor station")
	the_player:addToShipLog("Destroy the Kraylor station","Magenta")
	other_player:addToShipLog("Destroy the Kraylor station","Magenta")
end
function constructEnvironment()
	other_player = PlayerSpaceship():setTemplate("Atlantis"):setPosition(10000, 10000)
